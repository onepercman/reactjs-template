...
import { DialogSlotsClasses, DialogVariantProps, dialog } from "@/libs/ui/theme"
import * as Ark from "@ark-ui/react"
import React from "react"
import { LuX } from "react-icons/lu"

interface DialogProps extends Omit<Ark.DialogRootProps, "children">, DialogVariantProps, DialogSlotsClasses {
...
export const Dialog = _constructor(function (
  { trigger, title, children, size, placement, className, classNames, ...props },
  ref,
) {
  ...
  return (
    <Ark.Dialog.Root {...props}>
      ...
      <Ark.Portal>
        <Ark.Dialog.Backdrop className={classes.backdrop({ class: classNames?.backdrop })} />
        <Ark.Dialog.Positioner
          className={classes.positioner({ class: classNames?.positioner })}
          style={{ zIndex: "var(--z-index-modal)" }}
        >
          <Ark.Dialog.Content ref={ref} className={classes.base({ class: classNames?.base })}>
            <Ark.Dialog.Title className={classes.title({ class: classNames?.title })}>Dialog Title</Ark.Dialog.Title>
