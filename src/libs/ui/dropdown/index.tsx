          ...
          <div className="bg-component relative flex flex-col rounded p-1 shadow">
            {menu?.map((item, index) =>
              item.children?.length ? (
                ...
                >
                  <span className="hover:bg-secondary relative inline-flex w-full cursor-pointer items-center justify-between gap-2 rounded p-2">
                ...
                <div key={item.label!.toString() + item.key + index}>
                  <span
                    className={cn(
                      "hover:bg-secondary relative inline-flex w-full cursor-pointer items-center gap-2 rounded p-2 transition-colors",
