...
export interface ComboboxOption<T = any>
	extends HeadlessUI.ComboboxOptionProps<Button, T> {
...
interface Combobox extends ForwardedRefComponent {
	<
		...
		Multiple extends boolean | undefined,
	>(
		props: ForwardRefWithAsProps<
			Input,
			ComboboxProps<Value, Nullable, Multiple>
		>,
...
>(
	...
	return React.forwardRef<Input, ComboboxProps<Value, Nullable, Multiple>>(
		render,
	) as unknown as Combobox;
}

export const Combobox = _generate(function (
